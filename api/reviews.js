...
export default async function handler(request, response) {
    ...
    try {
        ...
        // ==============================================
        // 2. GET: OBTENER TODAS LAS RESEÑAS (Para el panel administrativo)
        // ==============================================
        if (request.method === 'GET' && action === 'getAllAdmin') {
            // Protección de ruta: Solo tú (la consultora) puedes ver esto
        ...
        if (request.method === 'POST' && action === 'sendRequest') {
                ...
                <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #eaeaea; border-radius: 10px; overflow: hidden;">
                    ...
                    <div style="padding: 30px; background-color: #ffffff;">
                        ...
                        <p style="font-size: 16px; line-height: 1.6; color: #4A4A4A;">
                            ...
                            El crecimiento y la mejora continua son fundamentales en el trabajo de la <strong>Psicóloga Marcela Villegas Gallego</strong>. Por ello, te invitamos a compartir un breve testimonio sobre tu experiencia en nuestras sesiones.
                        </p>
                        <p style="font-size: 16px; line-height: 1.6; color: #4A4A4A;">
            ...
            await resend.emails.send({
                ...
                to: email,
                subject: `⭐ ¿Cómo fue tu experiencia con la Psicóloga Marcela Villegas?`,
                html: htmlCorreo
            });
